...
# **rasterize_unicode**
> UnicodeOutputBody rasterize_unicode(unicode_input_body)
...
with stripyhorse.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = stripyhorse.ConvertApi(api_client)
    unicode_input_body = stripyhorse.UnicodeInputBody() # UnicodeInputBody | 

    try:
        # Make Unicode ZPL printable on any Zebra
        api_response = api_instance.rasterize_unicode(unicode_input_body)
        print("The response of ConvertApi->rasterize_unicode:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ConvertApi->rasterize_unicode: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **unicode_input_body** | [**UnicodeInputBody**](UnicodeInputBody.md)|  | 
