...
class TestUpdatePrinterInputBody(unittest.TestCase):
    """UpdatePrinterInputBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePrinterInputBody:
        """Test UpdatePrinterInputBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePrinterInputBody`
        """
    ...
    def testUpdatePrinterInputBody(self):
        """Test UpdatePrinterInputBody"""
