...
class TestMediaInputBody(unittest.TestCase):
    """MediaInputBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MediaInputBody:
        """Test MediaInputBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MediaInputBody`
        """
        model = MediaInputBody()
        if include_optional:
            return MediaInputBody(
                labels = 0,
                ribbon_metres = 0
            )
        else:
