...
class TestJobOutputBody(unittest.TestCase):
    """JobOutputBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobOutputBody:
        """Test JobOutputBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobOutputBody`
        """
        model = JobOutputBody()
        if include_optional:
