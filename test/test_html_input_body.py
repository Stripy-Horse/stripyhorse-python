...
class TestHtmlInputBody(unittest.TestCase):
    """HtmlInputBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HtmlInputBody:
        """Test HtmlInputBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HtmlInputBody`
        """
        model = HtmlInputBody()
        if include_optional:
            return HtmlInputBody(
                compression = 'acs',
                dpmm = 6,
                height_mm = 0,
                html = '',
