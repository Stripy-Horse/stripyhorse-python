...
class TestStampInputBody(unittest.TestCase):
    """StampInputBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StampInputBody:
        """Test StampInputBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StampInputBody`
        """
        model = StampInputBody()
        if include_optional:
            return StampInputBody(
                image = '',
                width_dots = 0,
                x = 0,
                y = 0,
