...
class TestZplHTMLOutputBody(unittest.TestCase):
    """ZplHTMLOutputBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ZplHTMLOutputBody:
        """Test ZplHTMLOutputBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ZplHTMLOutputBody`
        """
        model = ZplHTMLOutputBody()
        if include_optional:
    ...
    def testZplHTMLOutputBody(self):
        """Test ZplHTMLOutputBody"""
