...
class TestStateOutputBody(unittest.TestCase):
    """StateOutputBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StateOutputBody:
        """Test StateOutputBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StateOutputBody`
        """
        model = StateOutputBody()
        if include_optional:
