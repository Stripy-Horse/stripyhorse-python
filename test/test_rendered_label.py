...
class TestRenderedLabel(unittest.TestCase):
    """RenderedLabel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RenderedLabel:
        """Test RenderedLabel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RenderedLabel`
        """
        model = RenderedLabel()
        if include_optional:
