...
class TestHeldJob(unittest.TestCase):
    """HeldJob unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HeldJob:
        """Test HeldJob
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HeldJob`
        """
        model = HeldJob()
        if include_optional:
            return HeldJob(
