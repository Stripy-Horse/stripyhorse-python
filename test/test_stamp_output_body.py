...
class TestStampOutputBody(unittest.TestCase):
    """StampOutputBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StampOutputBody:
        """Test StampOutputBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StampOutputBody`
        """
        model = StampOutputBody()
        if include_optional:
