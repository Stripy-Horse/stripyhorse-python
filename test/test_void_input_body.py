...
class TestVoidInputBody(unittest.TestCase):
    """VoidInputBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VoidInputBody:
        """Test VoidInputBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VoidInputBody`
        """
        model = VoidInputBody()
        if include_optional:
            return VoidInputBody(
                dpmm = 6,
                height_mm = 0,
                preset = '4x6',
                stamp = '',
