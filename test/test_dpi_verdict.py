...
class TestDPIVerdict(unittest.TestCase):
    """DPIVerdict unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DPIVerdict:
        """Test DPIVerdict
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DPIVerdict`
        """
        model = DPIVerdict()
        if include_optional:
            return DPIVerdict(
