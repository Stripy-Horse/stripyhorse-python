...
class TestHtmlOutputBody(unittest.TestCase):
    """HtmlOutputBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HtmlOutputBody:
        """Test HtmlOutputBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HtmlOutputBody`
        """
        model = HtmlOutputBody()
        if include_optional:
