...
class TestZplHTMLInputBody(unittest.TestCase):
    """ZplHTMLInputBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ZplHTMLInputBody:
        """Test ZplHTMLInputBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ZplHTMLInputBody`
        """
        model = ZplHTMLInputBody()
        if include_optional:
            return ZplHTMLInputBody(
                dpmm = 6,
                height_mm = 0,
                preset = '4x6',
                width_mm = 0,
