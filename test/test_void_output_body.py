...
class TestVoidOutputBody(unittest.TestCase):
    """VoidOutputBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VoidOutputBody:
        """Test VoidOutputBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VoidOutputBody`
        """
        model = VoidOutputBody()
        if include_optional:
