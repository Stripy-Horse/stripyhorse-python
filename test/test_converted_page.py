...
class TestConvertedPage(unittest.TestCase):
    """ConvertedPage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConvertedPage:
        """Test ConvertedPage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConvertedPage`
        """
        model = ConvertedPage()
        if include_optional:
