...
class TestStatusField(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StatusField:
        """Test StatusField
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatusField`
        """
        model = StatusField()
        if include_optional:
            return StatusField(
