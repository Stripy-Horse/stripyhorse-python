...
from stripyhorse.configuration import Configuration
from stripyhorse.api_response import ApiResponse, T as ApiResponseT
import stripyhorse.models
from stripyhorse import rest
from stripyhorse.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(stripyhorse.models, klass)
