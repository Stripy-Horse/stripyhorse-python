...
class ComposeApi:
    ...
    def compose_label(
        self,
        compose_input_body: ComposeInputBody,
        ...
        :param compose_input_body: (required)
        :type compose_input_body: ComposeInputBody
        ...
        _param = self._compose_label_serialize(
            compose_input_body=compose_input_body,
    ...
    @validate_call
    def compose_label_with_http_info(
        self,
        compose_input_body: ComposeInputBody,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def compose_label_without_preload_content(
        self,
        compose_input_body: ComposeInputBody,
        _request_timeout: Union[
            None,
    ...
    def _compose_label_serialize(
        ...
        if compose_input_body is not None:
            _body_params = compose_input_body
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/labels/compose',
