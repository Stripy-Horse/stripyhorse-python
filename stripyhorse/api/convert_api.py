...
class ConvertApi:
    ...
    @validate_call
    def rasterize_unicode(
        self,
        unicode_input_body: UnicodeInputBody,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._rasterize_unicode_serialize(
            unicode_input_body=unicode_input_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def rasterize_unicode_with_http_info(
        self,
        unicode_input_body: UnicodeInputBody,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def rasterize_unicode_without_preload_content(
        self,
        unicode_input_body: UnicodeInputBody,
        _request_timeout: Union[
            None,
    ...
    def _rasterize_unicode_serialize(
        self,
        unicode_input_body,
        _request_auth,
        _content_type,
        ...
        # process the form parameters
        # process the body parameter
        if unicode_input_body is not None:
            _body_params = unicode_input_body
    ...
    def stamp_zpl(
        self,
        stamp_input_body: StampInputBody,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param stamp_input_body: (required)
        :type stamp_input_body: StampInputBody
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._stamp_zpl_serialize(
            stamp_input_body=stamp_input_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def stamp_zpl_without_preload_content(
        self,
        stamp_input_body: StampInputBody,
        _request_timeout: Union[
            None,
    ...
    def _stamp_zpl_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if stamp_input_body is not None:
            _body_params = stamp_input_body
