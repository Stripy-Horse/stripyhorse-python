...
class ZplHTMLOutputBody(BaseModel):
    """
    ZplHTMLOutputBody
    """ # noqa: E501
    html: StrictStr = Field(description="Editable HTML in the convertHtml dialect")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ZplHTMLOutputBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ZplHTMLOutputBody from a dict"""
        if obj is None:
            return None
