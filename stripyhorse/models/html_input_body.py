...
class HtmlInputBody(BaseModel):
    ...
    html: StrictStr = Field(description="Label markup: HTML/CSS plus <zpl-barcode> elements")
    ...
    __properties: ClassVar[List[str]] = ["compression", "dpmm", "heightMm", "html", "preset", "threshold", "widthMm"]
    ...
    def compression_validate_enum(cls, value):
        ...
        if value not in set(['acs', 'z64']):
            raise ValueError("must be one of enum values ('acs', 'z64')")
        return value
