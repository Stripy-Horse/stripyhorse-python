...
class UnicodeOutputBody(BaseModel):
    """
    UnicodeOutputBody
    """ # noqa: E501
    fields_rasterized: StrictInt = Field(alias="fieldsRasterized")
    skipped: Optional[List[StrictStr]] = None
    zpl: StrictStr
    __properties: ClassVar[List[str]] = ["fieldsRasterized", "skipped", "zpl"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.skipped is None and "skipped" in self.model_fields_set:
            _dict['skipped'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fieldsRasterized": obj.get("fieldsRasterized"),
