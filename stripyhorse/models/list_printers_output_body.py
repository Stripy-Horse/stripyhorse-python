...
class ListPrintersOutputBody(BaseModel):
    """
    ListPrintersOutputBody
    """ # noqa: E501
    printers: Optional[List[PrinterBody]]
    __properties: ClassVar[List[str]] = ["printers"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.printers is None and "printers" in self.model_fields_set:
            _dict['printers'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "printers": [PrinterBody.from_dict(_item) for _item in obj["printers"]] if obj.get("printers") is not None else None
        })
        return _obj
