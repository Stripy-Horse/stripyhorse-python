...
class JobOutputBody(BaseModel):
    """
    JobOutputBody
    """ # noqa: E501
    labels: Optional[List[StrictStr]] = Field(description="URLs of the rendered label PNGs")
    zpl: StrictStr = Field(description="The raw ZPL as received")
    __properties: ClassVar[List[str]] = ["labels", "zpl"]
