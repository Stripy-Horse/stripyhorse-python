...
class ComposeInputBody(BaseModel):
    ...
    def preset_validate_enum(cls, value):
        ...
        if value not in set(['4x6', '6x4', '4x4', '4x2', '2x4', '3x5', '5x3', '2x3', '3x2', 'netstamp', '2.25x1.25', '1.5x1', '2x1', '3x1', '4x1', '1x1', '4x3', '4x8', 'a6']):
            raise ValueError("must be one of enum values ('4x6', '6x4', '4x4', '4x2', '2x4', '3x5', '5x3', '2x3', '3x2', 'netstamp', '2.25x1.25', '1.5x1', '2x1', '3x1', '4x1', '1x1', '4x3', '4x8', 'a6')")
        return value
