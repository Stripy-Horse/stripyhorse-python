...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "bearerKey": BearerFormatAuthSetting,
        "headerKey": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = stripyhorse.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.stripyhorse.io" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("stripyhorse")
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            {
                'url': "https://api.stripyhorse.io",
                'description': "No description provided",
            },
            {
                'url': "https://stripyhorse.io",
                'description': "No description provided",
            }
        ]
